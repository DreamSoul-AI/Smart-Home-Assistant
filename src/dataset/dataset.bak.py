    ...
    def preprocess_function_token(examples):
        ...
        for i in range(batch_size):
            ...
            for j in range(len(d_name)):
                month_j, day_j, hour_j, minute_j, second_j = (ts[j].month, ts[j].day, ts[j].hour,  # 转数字
                                                              ts[j].minute, ts[j].second)

                time_j = 'Month: {}, Day: {}, Hour: {}, Minute: {}, Second: {}'.format(month_j, day_j,
                                                                                       hour_j, minute_j, second_j)
                device_j = 'Name: {}, Function: {}, Info: {}'.format(d_name[j], d_func[j], d_type[j])  # embedding
            ...
            # print('--------------output_info---------------')
            # print(f'input_ids_{i}.shape:{input_ids_i.shape}')
            # print(f'attention_mask_{i}.shape:{attention_mask_i.shape}')
            # print('--------------------------------------------------------')
